...
namespace FullscreenEditor {
    ...
    internal class Shortcut {
        ...
        [DynamicMenuItem(true)] public const string TOOLBAR_PATH = "VRPark/Utilities/Fullscreen/Show Toolbar "; //_F8
        [DynamicMenuItem(true)] public const string FULLSCREEN_ON_PLAY_PATH = "VRPark/Utilities/Fullscreen/Fullscreen On Play ";
        [DynamicMenuItem(true)] public const string PREFERENCES_PATH = "VRPark/Utilities/Fullscreen/Preferences... ";
        [DynamicMenuItem(false)] public const string CURRENT_VIEW_PATH = "VRPark/Utilities/Fullscreen/Focused View "; //_F10
        [DynamicMenuItem(false)] public const string GAME_VIEW_PATH = "VRPark/Utilities/Fullscreen/Game View "; //" _F10";
        [DynamicMenuItem(false)] public const string SCENE_VIEW_PATH = "VRPark/Utilities/Fullscreen/Scene View "; // _F11
        [DynamicMenuItem(false)] public const string MAIN_VIEW_PATH = "VRPark/Utilities/Fullscreen/Main View _F11";
        [DynamicMenuItem(false)] public const string MOSAIC_PATH = "VRPark/Utilities/Fullscreen/Mosaic "; //%F10
        [DynamicMenuItem(true)] public const string CLOSE_ALL_FULLSCREEN = "VRPark/Utilities/Fullscreen/Close All "; //%F12
