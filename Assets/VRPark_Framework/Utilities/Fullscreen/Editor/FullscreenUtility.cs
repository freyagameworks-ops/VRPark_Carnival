...
namespace FullscreenEditor {
    ...
    public static class FullscreenUtility {
        ...
        /// <summary>Does the given <see cref="MenuItem"/> path contain a key binding?</summary>
        public static bool MenuItemHasShortcut(string menuItemPath) {
            try {
                ...
                Debug.Log("Error in MenuItemHasShortcut: " + ex.Message); // Uncomment to log the error
                return false;
            }
        }
