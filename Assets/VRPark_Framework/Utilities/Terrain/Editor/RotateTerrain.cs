...
namespace unitycoder_TerrainRotator
{
    ...
    public class RotateTerrain : EditorWindow
    {

        private const string appName = "Rotate Terrain";
        ...
        [MenuItem("VRPark/Utilities/Terrain/" + appName)]
        static void Init()
        {
            RotateTerrain window = (RotateTerrain)EditorWindow.GetWindow(typeof(RotateTerrain));
