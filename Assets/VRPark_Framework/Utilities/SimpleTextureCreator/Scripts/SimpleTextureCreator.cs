...
public class SimpleTextureCreator : EditorWindow
{
    // texture size
    ...
    private static string[] texTemplates = new[]
    {
        "Color Presets", "White", "Black", "Clear:Opacity 0%", "Red", "Green", "Blue", "Yellow", "Cyan", "Magenta",
        "Gray", "Brown"
    };
    ...
    private string[] texFormatInfo = new[]
    {
        "Alpha-only texture format", "A color texture format", "Color with an alpha channel texture format",
        "Color with an alpha channel texture format"
    };

    private TextureFormat[] texFormat = new[]
        { TextureFormat.Alpha8, TextureFormat.RGB24, TextureFormat.ARGB32, TextureFormat.RGBA32 };
    ...
    [MenuItem("VRPark/Utilities/Simple Texture Creator/Simple Texture Creator")]
    static void Init()
    {
        SimpleTextureCreator window = (SimpleTextureCreator)EditorWindow.GetWindow(typeof(SimpleTextureCreator));
