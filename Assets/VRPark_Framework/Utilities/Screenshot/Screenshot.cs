...
public sealed class Screenshot : EditorWindow
{
    ...
    [MenuItem("VRPark/Utilities/Screenshot/Screenshot")]
    public static void Init()
    {
        EditorWindow ssWindow = EditorWindow.GetWindow(typeof(Screenshot), false);
    ...
    void OnGUI()
    {
        ...
        //EditorGUILayout.LabelField(" - KIRCA STUDIOS - ", EditorStyles.centeredGreyMiniLabel);
