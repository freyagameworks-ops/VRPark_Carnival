...
{
    /// <summary>
    /// Contains all the methods used by better mesh to function
    /// </summary>
    public static class MeshExtension
    {
        #region Information

        public static int VertexCount(this Mesh mesh) => mesh.vertexCount;
        ...
        /// Note: Editor only
        /// </summary>
        public static Mesh GenerateSecondaryUVSetEditorOnly(this Mesh mesh)
        {
