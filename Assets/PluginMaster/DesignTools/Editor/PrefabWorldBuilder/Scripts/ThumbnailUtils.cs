...
namespace PluginMaster
{
    ...
    public class ThumbnailUtils
    {
        ...
        public static void UpdateThumbnail(MultibrushSettings brushSettings, bool updateItemThumbnails)
        {
            ...
            {
                if(updateItemThumbnails) UpdateThumbnail(item);
        ...
        public static void UpdateThumbnail(BrushSettings brushItem, bool updateItemThumbnails)
        {
            if (brushItem is MultibrushItemSettings) UpdateThumbnail(brushItem as MultibrushItemSettings);
            else if (brushItem is MultibrushSettings) UpdateThumbnail(brushItem as MultibrushSettings, updateItemThumbnails);
        }
