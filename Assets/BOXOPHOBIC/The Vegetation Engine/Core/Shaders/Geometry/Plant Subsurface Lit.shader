	...
	SubShader
	{
		...
		Pass
        {
			...
			VertexOutput VertexFunction(VertexInput inputMesh  )
			{
				...
				half2 Second_UVs_Offset7605_g76557 = (_SecondUVs).zw;
				float2 vertexToFrag11_g76583 = ( ( ( temp_output_30_0_g76677 + temp_output_29_0_g76677 + temp_output_31_0_g76677 ) * lerpResult7614_g76557 ) + Second_UVs_Offset7605_g76557 );
				o.ase_texcoord3.xy = vertexToFrag11_g76583;
				float3 ase_worldTangent = TransformObjectToWorldDir(inputMesh.ase_tangent.xyz);
				...
				o.ase_texcoord6.xyz = vertexToFrag3890_g76557;
				o.ase_texcoord7.xyz = vertexToFrag4224_g76557;
...
ASEEND*/
//CHKSM=B5A38D710EEEC9EBD3075E27BFEBC60C4AAD1C16
